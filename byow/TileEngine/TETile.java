...
public class TETile {
    ...
    public static TETile makeDimmer(TETile t, int number) {
        Color newText = t.textColor;
        Color newBackground = t.backgroundColor;
        for (int i = 0; i < number; i++) {
            newBackground = newBackground.darker();
            newText = newText.darker();
        }
        return new TETile(t.character, newText, newBackground, t.description, t.filepath);
    }
